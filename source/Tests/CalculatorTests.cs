...
public class CalculatorTests
{
    ...
    public static IEnumerable<object[]> TestDataDateTimeOffset()
    {
        return new List<object[]>
        {
            new object[] { GenerateDayDataDateSwedishTime(2024, 1, 1), 31 },
            new object[] { GenerateDayDataDateSwedishTime(2024, 2, 4), 0 },
            new object[] { GenerateDayDataDateSwedishTime(2024, 3, 10), 0 }, // Sunday
            new object[] { GenerateDayDataDateSwedishTime(2024, 4, 6), 0 },  // Saturday
            new object[] { GenerateDayDataDateSwedishTime(2024, 5, 15), 31 },
            new object[] { GenerateDayDataDateSwedishTime(2024, 6, 1), 0 },  // Saturday
            new object[] { GenerateDayDataDateSwedishTime(2024, 7, 21), 0 }, // Sunday
            new object[] { GenerateDayDataDateSwedishTime(2024, 8, 18), 0 }, // Sunday
            new object[] { GenerateDayDataDateSwedishTime(2024, 9, 9), 31 },
            new object[] { GenerateDayDataDateSwedishTime(2024, 10, 5), 0 }, // Saturday
            new object[] { GenerateDayDataDateSwedishTime(2024, 11, 11), 31 },
            new object[] { GenerateDayDataDateSwedishTime(2024, 12, 25), 31 }, // Christmas Day (Wednesday in 2024)
            new object[] { GenerateDayDataDateSwedishTime(2024, 1, 14), 0 }, // Sunday
            new object[] { GenerateDayDataDateSwedishTime(2024, 2, 17), 0}, // Saturday
            new object[] { GenerateDayDataDateSwedishTime(2024, 3, 18), 31 },
            new object[] { GenerateDayDataDateSwedishTime(2024, 4, 20), 0 }, // Saturday
            new object[] { GenerateDayDataDateSwedishTime(2024, 5, 19), 0 }, // Sunday
            new object[] { GenerateDayDataDateSwedishTime(2024, 6, 23), 0 }, // Sunday
            new object[] { GenerateDayDataDateSwedishTime(2024, 7, 3), 31 },
            new object[] { GenerateDayDataDateSwedishTime(2024, 8, 24), 0 }  // Saturday
        };
    }
    ...
    private static DateTimeOffset[] GenerateDayDataDateSwedishTime(int year, int month, int day, int passages=5)
    {
        var dates = GenerateDayData(year, month, day, passages);
